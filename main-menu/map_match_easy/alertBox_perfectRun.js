...
function handleLeftDivTopText() {
    leftDivTopText.innerText = 'PERFECT RUN'
...
function handleRightDivTopText() {
    rightDivTopText.innerText = 'FINISH @'
    rightDivTopText.style.fontSize = '2rem'
...
function handleRightDivTime() {
    rightDivTimeDisplay.innerText = '3:00';
    rightDivTimeDisplay.style.fontSize = '3rem'
...
function handleBtnNextLevel() {
    ...
    btnNextLevel.innerText = "Play Medium"
