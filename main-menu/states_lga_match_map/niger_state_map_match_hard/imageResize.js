...
resizeImage.AgaieLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Agaie, 25, 50);
});
...
resizeImage.BidaLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Bida, 30, 40)
});
...
resizeImage.EdatiLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Edati, 35, 20);
})

resizeImage.GbakoLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Gbako, 25, 50);
})
...
resizeImage.KontagoraLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Kontagora, 55, 35);
})

resizeImage.LapaiLGA.addEventListener('dragstart',(e)=>{
   // e.dataTransfer.setDragImage(images.Lapai, 53, 40);
   e.dataTransfer.setDragImage(images.Lapai, 35, 100);
})

resizeImage.LavunLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Lavun, 45, 60);
})

resizeImage.MagamaLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Magama, 78, 44);
})

resizeImage.MarigaLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Mariga, 68, 65);
})

resizeImage.MasheguLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Mashegu, 90, 52);
})

resizeImage.MokwaLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Mokwa, 97, 52);
})

resizeImage.MunyaLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Munya, 35, 35);
})
...
resizeImage.RafiLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Rafi, 50, 50);
})

resizeImage.RijauLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Rijau, 70, 40);
})

resizeImage.ShiroroLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Shiroro, 80, 64);
})

// to be revisited
resizeImage.SulejaLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Suleja, 8, 11);
})
// to be revisited
...
resizeImage.WushishiLGA.addEventListener('dragstart',(e)=>{
   e.dataTransfer.setDragImage(images.Wushishi, 60, 40);
})
